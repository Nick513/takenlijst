                ...
                <div class="col-lg-4 col-md-5 col-md-offset-4 col-xs-6">
                    <div class="add-control">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control add-task" placeholder="✍️{{ trans('page.homepage.tasks.add') }}"/>
                            <i class="fa fa-plus form-control-feedback add-btn" title="Add item"></i>
                        </div>
                    </div>
                    <p class="no-items text-muted text-center @if(count($tasks) > 0) hidden @endif"><i class="fa fa-ban"></i></p>
                    <ul class="todo-list">
                    ...
                    <div class="w-100 text-center mb-3">
                        <a class="refresh text-decoration-none @if(count($tasks) === 0) hidden @endif" href="javascript:void(0);">{{ trans('page.homepage.delete.all.tasks') }}</a>
                    </div>
                </div>
            </div>
        @endauth
